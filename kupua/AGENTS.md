...
kupua/
  ...
  src/                         # ~16,300 lines total
    ...
    lib/
      ...
      sort-focus.ts            # Transient bridge for viewport-position preservation across sort changes — saves ratio (same pattern as density-focus.ts)
      ...
      scroll-reset-ref.ts      # Module-level ref for virtualizer scroll reset — registerScrollReset(cb) called by density components on mount; fireScrollReset() called by scroll-reset.ts on Home/logo click. Same pattern as scroll-container-ref.ts.
