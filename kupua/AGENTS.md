...
**Post-perf regression fixes** (`post-perf-fixes.md`) — Issue 1 ✅ (Home button), Issue 2 ✅ (P6 sort-focus ratio + P4b header offset), Issue 3 ✅ (A.4 revert). **Awaiting E2E validation** — tests could not run during this session (live data mode active). Run `npx playwright test` to validate.
