...
| P03 | Reverse scroll across buffer start and prepend | Visible order reverses monotonically; prepend compensation avoids jump/swim | ES backward fetch + compensation | [habitual backward E2E](../../../e2e/local/scrubber.spec.ts#L336-L492) | Direct: P17 |
...
| L02 | Add/remove an in-buffer range | Anchor polarity and contiguous IDs produce one atomic Set update | Client map walk + reconcile | [grid/table selection E2E](../../../e2e/local/selections.spec.ts#L308-L397), [coarse-pointer range E2E](../../../e2e/local/selections-mobile.spec.ts#L212-L270) | Direct: P18 (100 items, Details open) |
...
| L08 | Reconcile and render metadata for large/mixed selection | Chunked reconciliation settles; multi-image fields/counts match selected denominator | Idle chunks + React panel + optional mget | [selection owner](../00%20Architecture%20and%20philosophy/component-detail.md#L141-L162), [metadata E2E](../../../e2e/local/selections.spec.ts#L434-L615) | Direct: P18 at 100; 2k–5k remains product-gated |
...
| H05 | Leave and restore a deep list position | Snapshot anchor/ratio restores visibly, including conditional buffer load | sessionStorage + history + search/seek | [history E2E](../../../e2e/local/browser-history.spec.ts#L878-L924) | Direct perceived: PP11 |
