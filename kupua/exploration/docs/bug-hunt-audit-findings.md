...
**Date:** 28 April 2026
**Status:** Batch A complete (28 April 2026). Bugs #1, #2, #19, #20 fixed. Bug #13 confirmed not a real bug — see note. Batch B in progress: Bug #9 fixed (28 April 2026). Bug #8 fixed (28 April 2026).
