...
/**
 * Subtype of {@link com.gu.typesafe.config.ConfigValue} representing an object (AKA dictionary or map)
 ...
 *
 * <p>
 * Like all {@link com.gu.typesafe.config.ConfigValue} subtypes, {@code ConfigObject} is immutable.
 ...
 *
 * <p>
 * The {@link com.gu.typesafe.config.ConfigValue#valueType} method on an object returns
 ...
 *
 * <p>
 * Use {@link com.gu.typesafe.config.ConfigUtil#joinPath} and {@link ConfigUtil#splitPath} to convert
 * between path expressions and individual path elements (keys).
 *
 * <p>
 * A {@code ConfigObject} may contain null values, which will have
 * {@link com.gu.typesafe.config.ConfigValue#valueType()} equal to {@link ConfigValueType#NULL}. If
 ...
 * {@code get("key")} returns a {@link com.gu.typesafe.config.ConfigValue} with type
 ...
 */
public interface ConfigObject extends com.gu.typesafe.config.ConfigValue, Map<String, com.gu.typesafe.config.ConfigValue> {
    ...
    /**
     * Gets a {@link com.gu.typesafe.config.ConfigValue} at the given key, or returns null if there is
     * no value. The returned {@link com.gu.typesafe.config.ConfigValue} may have
     ...
     */
    @Override
    com.gu.typesafe.config.ConfigValue get(Object key);
