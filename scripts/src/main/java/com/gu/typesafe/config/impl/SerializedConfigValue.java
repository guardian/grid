 ...
 */
class SerializedConfigValue extends com.gu.typesafe.config.impl.AbstractConfigValue implements Externalizable {
    ...
    private static enum SerializedValueType {
        ...
        NULL(com.gu.typesafe.config.ConfigValueType.NULL),
        BOOLEAN(com.gu.typesafe.config.ConfigValueType.BOOLEAN),
        INT(com.gu.typesafe.config.ConfigValueType.NUMBER),
        LONG(com.gu.typesafe.config.ConfigValueType.NUMBER),
        DOUBLE(com.gu.typesafe.config.ConfigValueType.NUMBER),
        STRING(com.gu.typesafe.config.ConfigValueType.STRING),
        LIST(com.gu.typesafe.config.ConfigValueType.LIST),
        OBJECT(com.gu.typesafe.config.ConfigValueType.OBJECT);

        com.gu.typesafe.config.ConfigValueType configType;

        SerializedValueType(com.gu.typesafe.config.ConfigValueType configType) {
        ...
        static SerializedValueType forValue(com.gu.typesafe.config.ConfigValue value) {
            com.gu.typesafe.config.ConfigValueType t = value.valueType();
            if (t == com.gu.typesafe.config.ConfigValueType.NUMBER) {
                if (value instanceof com.gu.typesafe.config.impl.ConfigInt)
                    return INT;
            ...
            throw new com.gu.typesafe.config.ConfigException.BugOrBroken("don't know how to serialize " + value);
        }
    };

    private com.gu.typesafe.config.ConfigValue value;
    ...
    SerializedConfigValue(com.gu.typesafe.config.ConfigValue value) {
        this();
        this.value = value;
    ...
    private Object readResolve() throws ObjectStreamException {
        if (wasConfig)
            return ((com.gu.typesafe.config.ConfigObject) value).toConfig();
        else
            return value;
    }
    ...
    private static void writeValueData(DataOutput out, com.gu.typesafe.config.ConfigValue value) throws IOException {
        ...
        case INT:
            ...
            out.writeInt(((com.gu.typesafe.config.impl.ConfigInt) value).unwrapped());
        ...
        case STRING:
            ...
            break;
        case LIST:
            com.gu.typesafe.config.ConfigList list = (ConfigList) value;
            ...
            break;
        case OBJECT:
            com.gu.typesafe.config.ConfigObject obj = (ConfigObject) value;
            out.writeInt(obj.size());
            for (Map.Entry<String, com.gu.typesafe.config.ConfigValue> e : obj.entrySet()) {
    ...
    private static com.gu.typesafe.config.impl.AbstractConfigValue readValueData(DataInput in, SimpleConfigOrigin origin)
            throws IOException {
        ...
        case INT:
            ...
            return new com.gu.typesafe.config.impl.ConfigInt(origin, vi, si);
        case LONG:
            long vl = in.readLong();
        ...
        case LIST:
            ...
            List<com.gu.typesafe.config.impl.AbstractConfigValue> list = new ArrayList<com.gu.typesafe.config.impl.AbstractConfigValue>(listSize);
            for (int i = 0; i < listSize; ++i) {
                com.gu.typesafe.config.impl.AbstractConfigValue v = readValue(in, origin);
                list.add(v);
            }
            return new SimpleConfigList(origin, list);
        case OBJECT:
            int mapSize = in.readInt();
            Map<String, com.gu.typesafe.config.impl.AbstractConfigValue> map = new HashMap<String, com.gu.typesafe.config.impl.AbstractConfigValue>(mapSize);
    ...
    private static com.gu.typesafe.config.impl.AbstractConfigValue readValue(DataInput in, SimpleConfigOrigin baseOrigin)
            throws IOException {
        com.gu.typesafe.config.impl.AbstractConfigValue value = null;
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        if (((com.gu.typesafe.config.impl.AbstractConfigValue) value).resolveStatus() != ResolveStatus.RESOLVED)
    ...
    private static com.gu.typesafe.config.ConfigException shouldNotBeUsed() {
