...
import com.gu.typesafe.config.impl.ConfigImplUtil;
...
public final class ConfigParseOptions {
    final com.gu.typesafe.config.ConfigSyntax syntax;
    final String originDescription;
    final boolean allowMissing;
    final com.gu.typesafe.config.ConfigIncluder includer;
    final ClassLoader classLoader;

    private ConfigParseOptions(com.gu.typesafe.config.ConfigSyntax syntax, String originDescription, boolean allowMissing,
                               com.gu.typesafe.config.ConfigIncluder includer, ClassLoader classLoader) {
        this.syntax = syntax;
     ...
     * filename extension; if guessing fails, assume {@link com.gu.typesafe.config.ConfigSyntax#CONF}.
     *
     * @param syntax
     *            a syntax or {@code null} for best guess
     * @return options with the syntax set
     */
    public ConfigParseOptions setSyntax(com.gu.typesafe.config.ConfigSyntax syntax) {
    ...
    /**
     * Set the file format. If set to null, assume {@link com.gu.typesafe.config.ConfigSyntax#CONF}.
     *
     * @param filename
    ...
    public ConfigParseOptions setSyntaxFromFilename(String filename) {
        com.gu.typesafe.config.ConfigSyntax syntax = ConfigImplUtil.syntaxFromExtension(filename);
    ...
    /**
     * Set a {@link com.gu.typesafe.config.ConfigIncluder} which customizes how includes are handled.
     ...
     */
    public ConfigParseOptions setIncluder(com.gu.typesafe.config.ConfigIncluder includer) {
    ...
    /**
     * Prepends a {@link com.gu.typesafe.config.ConfigIncluder} which customizes how
     * includes are handled.  To prepend your includer, the
     * library calls {@link com.gu.typesafe.config.ConfigIncluder#withFallback} on your
     * includer to append the existing includer to it.
     *
     * @param includer the includer to prepend (may not be null)
     * @return new version of the parse options with different includer
     */
    public ConfigParseOptions prependIncluder(com.gu.typesafe.config.ConfigIncluder includer) {
        if (includer == null)
    ...
    /**
     * Appends a {@link com.gu.typesafe.config.ConfigIncluder} which customizes how
     * includes are handled.  To append, the library calls {@link
     * com.gu.typesafe.config.ConfigIncluder#withFallback} on the existing includer.
     *
     * @param includer the includer to append (may not be null)
     * @return new version of the parse options with different includer
     */
    public ConfigParseOptions appendIncluder(com.gu.typesafe.config.ConfigIncluder includer) {
        if (includer == null)
