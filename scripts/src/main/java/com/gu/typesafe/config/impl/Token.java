...
class Token {
    final private com.gu.typesafe.config.impl.TokenType tokenType;
    final private String debugString;
    final private com.gu.typesafe.config.ConfigOrigin origin;
    final private String tokenText;

    Token(com.gu.typesafe.config.impl.TokenType tokenType, com.gu.typesafe.config.ConfigOrigin origin) {
        this(tokenType, origin, null);
    }

    Token(com.gu.typesafe.config.impl.TokenType tokenType, com.gu.typesafe.config.ConfigOrigin origin, String tokenText) {
        this(tokenType, origin, tokenText, null);
    }

    Token(com.gu.typesafe.config.impl.TokenType tokenType, com.gu.typesafe.config.ConfigOrigin origin, String tokenText, String debugString) {
    ...
    static Token newWithoutOrigin(com.gu.typesafe.config.impl.TokenType tokenType, String debugString, String tokenText) {
        return new Token(tokenType, null, tokenText, debugString);
    }

    final com.gu.typesafe.config.impl.TokenType tokenType() {
        return tokenType;
    }
