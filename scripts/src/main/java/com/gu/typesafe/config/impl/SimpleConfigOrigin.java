...
import com.gu.typesafe.config.impl.SerializedConfigValue.SerializedField;
...
final class SimpleConfigOrigin implements com.gu.typesafe.config.ConfigOrigin {
    ...
    protected SimpleConfigOrigin(String description, int lineNumber, int endLineNumber, OriginType originType,
        ...
        if (description == null)
            throw new com.gu.typesafe.config.ConfigException.BugOrBroken("description may not be null");
    ...
    static com.gu.typesafe.config.ConfigOrigin mergeOrigins(com.gu.typesafe.config.ConfigOrigin a, com.gu.typesafe.config.ConfigOrigin b) {
        return mergeTwo((SimpleConfigOrigin) a, (SimpleConfigOrigin) b);
    }

    static com.gu.typesafe.config.ConfigOrigin mergeOrigins(List<? extends com.gu.typesafe.config.impl.AbstractConfigValue> stack) {
        List<com.gu.typesafe.config.ConfigOrigin> origins = new ArrayList<com.gu.typesafe.config.ConfigOrigin>(stack.size());
    ...
    static com.gu.typesafe.config.ConfigOrigin mergeOrigins(Collection<? extends com.gu.typesafe.config.ConfigOrigin> stack) {
        if (stack.isEmpty()) {
            throw new com.gu.typesafe.config.ConfigException.BugOrBroken("can't merge empty list of origins");
        } else if (stack.size() == 1) {
            return stack.iterator().next();
        } else if (stack.size() == 2) {
            Iterator<? extends com.gu.typesafe.config.ConfigOrigin> i = stack.iterator();
