...
final class SimpleConfigList extends com.gu.typesafe.config.impl.AbstractConfigValue implements ConfigList, com.gu.typesafe.config.impl.Container, Serializable {

    private static final long serialVersionUID = 2L;

    final private List<com.gu.typesafe.config.impl.AbstractConfigValue> value;
    final private boolean resolved;

    SimpleConfigList(com.gu.typesafe.config.ConfigOrigin origin, List<com.gu.typesafe.config.impl.AbstractConfigValue> value) {
    ...
    public List<Object> unwrapped() {
        ...
        for (com.gu.typesafe.config.impl.AbstractConfigValue v : value) {
    ...
    @Override
    public SimpleConfigList replaceChild(com.gu.typesafe.config.impl.AbstractConfigValue child, com.gu.typesafe.config.impl.AbstractConfigValue replacement) {
        List<com.gu.typesafe.config.impl.AbstractConfigValue> newList = replaceChildInList(value, child, replacement);
        if (newList == null) {
            return null;
        } else {
    ...
    private SimpleConfigList modifyMayThrow(Modifier modifier, ResolveStatus newResolveStatus)
        ...
        List<com.gu.typesafe.config.impl.AbstractConfigValue> changed = null;
        int i = 0;
        for (com.gu.typesafe.config.impl.AbstractConfigValue v : value) {
            com.gu.typesafe.config.impl.AbstractConfigValue modified = modifier.modifyChildMayThrow(null /* key */, v);

            // lazy-create the new list if required
            if (changed == null && modified != v) {
                changed = new ArrayList<com.gu.typesafe.config.impl.AbstractConfigValue>();
                for (int j = 0; j < i; ++j) {
    ...
    private static class ResolveModifier implements Modifier {
        ...
        @Override
        public com.gu.typesafe.config.impl.AbstractConfigValue modifyChildMayThrow(String key, com.gu.typesafe.config.impl.AbstractConfigValue v)
                    throws NotPossibleToResolve {
            com.gu.typesafe.config.impl.ResolveResult<? extends com.gu.typesafe.config.impl.AbstractConfigValue> result = context.resolve(v, source);
    ...
    @Override
    com.gu.typesafe.config.impl.ResolveResult<? extends SimpleConfigList> resolveSubstitutions(com.gu.typesafe.config.impl.ResolveContext context, com.gu.typesafe.config.impl.ResolveSource source)
            throws NotPossibleToResolve {
        if (resolved)
        ...
        if (context.isRestrictedToChild()) {
            ...
            try {
                ...
                return com.gu.typesafe.config.impl.ResolveResult.make(modifier.context, value);
    ...
    @Override
    public com.gu.typesafe.config.impl.AbstractConfigValue get(int index) {
    ...
    @Override
    public Iterator<com.gu.typesafe.config.ConfigValue> iterator() {
        final Iterator<com.gu.typesafe.config.impl.AbstractConfigValue> i = value.iterator();

        return new Iterator<com.gu.typesafe.config.ConfigValue>() {
            @Override
            ...
            @Override
            public com.gu.typesafe.config.ConfigValue next() {
                return i.next();
            }
    ...
    private static ListIterator<com.gu.typesafe.config.ConfigValue> wrapListIterator(
            final ListIterator<com.gu.typesafe.config.impl.AbstractConfigValue> i) {
        return new ListIterator<com.gu.typesafe.config.ConfigValue>() {
            @Override
            public boolean hasNext() {
                return i.hasNext();
            }
            ...
            @Override
            public void add(com.gu.typesafe.config.ConfigValue arg0) {
            ...
            @Override
            public com.gu.typesafe.config.ConfigValue previous() {
                return i.previous();
            }
            ...
            @Override
            public void set(com.gu.typesafe.config.ConfigValue arg0) {
    ...
    @Override
    public ListIterator<com.gu.typesafe.config.ConfigValue> listIterator() {
        return wrapListIterator(value.listIterator());
    }

    @Override
    public ListIterator<com.gu.typesafe.config.ConfigValue> listIterator(int index) {
    ...
    @Override
    public List<com.gu.typesafe.config.ConfigValue> subList(int fromIndex, int toIndex) {
        List<com.gu.typesafe.config.ConfigValue> list = new ArrayList<com.gu.typesafe.config.ConfigValue>();
        // yay bloat caused by lack of type variance
        for (com.gu.typesafe.config.impl.AbstractConfigValue v : value.subList(fromIndex, toIndex)) {
            list.add(v);
        }
        return list;
    }
    ...
    @Override
    public boolean add(com.gu.typesafe.config.ConfigValue e) {
        throw weAreImmutable("add");
    }

    @Override
    public void add(int index, com.gu.typesafe.config.ConfigValue element) {
        throw weAreImmutable("add");
    }

    @Override
    public boolean addAll(Collection<? extends com.gu.typesafe.config.ConfigValue> c) {
        throw weAreImmutable("addAll");
    }

    @Override
    public boolean addAll(int index, Collection<? extends com.gu.typesafe.config.ConfigValue> c) {
        throw weAreImmutable("addAll");
    }
    ...
    @Override
    public com.gu.typesafe.config.ConfigValue remove(int index) {
        throw weAreImmutable("remove");
    }
    ...
    @Override
    public com.gu.typesafe.config.ConfigValue set(int index, ConfigValue element) {
        throw weAreImmutable("set");
    }

    @Override
    protected SimpleConfigList newCopy(com.gu.typesafe.config.ConfigOrigin newOrigin) {
        return new SimpleConfigList(newOrigin, value);
    }

    final SimpleConfigList concatenate(SimpleConfigList other) {
        com.gu.typesafe.config.ConfigOrigin combinedOrigin = com.gu.typesafe.config.impl.SimpleConfigOrigin.mergeOrigins(origin(), other.origin());
        List<com.gu.typesafe.config.impl.AbstractConfigValue> combined = new ArrayList<com.gu.typesafe.config.impl.AbstractConfigValue>(value.size()
                + other.value.size());
