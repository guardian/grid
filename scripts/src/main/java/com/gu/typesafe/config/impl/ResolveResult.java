...
final class ResolveResult<V extends com.gu.typesafe.config.impl.AbstractConfigValue> {
    ...
    static <V extends com.gu.typesafe.config.impl.AbstractConfigValue> ResolveResult<V> make(ResolveContext context, V value) {
    ...
    // better option? we don't have variance
    @SuppressWarnings("unchecked")
    ResolveResult<com.gu.typesafe.config.impl.AbstractConfigValue> asValueResult() {
        Object o = this;
        return (ResolveResult<com.gu.typesafe.config.impl.AbstractConfigValue>) o;
    }
