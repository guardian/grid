...
import com.gu.typesafe.config.impl.ConfigImpl;
import com.gu.typesafe.config.impl.Parseable;
 ...
 *
 * <p>
 * See also {@link com.gu.typesafe.config.ConfigValueFactory} which contains static methods for
...
public final class ConfigFactory {
    ...
    public static Config load(String resourceBasename) {
        return load(resourceBasename, ConfigParseOptions.defaults(),
                com.gu.typesafe.config.ConfigResolveOptions.defaults());
    }
    ...
    public static Config load(String resourceBasename, ConfigParseOptions parseOptions,
            com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
    ...
    /**
     * Like {@link #load(String,ConfigParseOptions, com.gu.typesafe.config.ConfigResolveOptions)} but
     ...
     */
    public static Config load(ClassLoader loader, String resourceBasename,
            ConfigParseOptions parseOptions, com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
    ...
    public static Config load(ClassLoader loader, Config config) {
        return load(loader, config, com.gu.typesafe.config.ConfigResolveOptions.defaults());
    }

    /**
     * Like {@link #load(Config)} but allows you to specify
     * {@link com.gu.typesafe.config.ConfigResolveOptions}.
     *
     * @param config
     *            the application's portion of the configuration
     * @param resolveOptions
     ...
     * @return resolved configuration with overrides and fallbacks added
     */
    public static Config load(Config config, com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
        return load(checkedContextClassLoader("load"), config, resolveOptions);
    }

    /**
     * Like {@link #load(Config, com.gu.typesafe.config.ConfigResolveOptions)} but allows you to specify
     ...
     * @return resolved configuration with overrides and fallbacks added
     */
    public static Config load(ClassLoader loader, Config config, com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
    ...
    public static Config load(ConfigParseOptions parseOptions) {
        return load(parseOptions, com.gu.typesafe.config.ConfigResolveOptions.defaults());
    }
     ...
     * @return configuration for an application
     */
    public static Config load(ClassLoader loader, com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
     ...
     * @return configuration for an application
     */
    public static Config load(ClassLoader loader, ConfigParseOptions parseOptions, com.gu.typesafe.config.ConfigResolveOptions resolveOptions) {
    ...
    private static com.gu.typesafe.config.ConfigLoadingStrategy getConfigLoadingStrategy() {
