...
final class PathParser {
    ...
    static com.gu.typesafe.config.ConfigOrigin apiOrigin = SimpleConfigOrigin.newSimple("path parameter");

    static ConfigNodePath parsePathNode(String path) {
        return parsePathNode(path, com.gu.typesafe.config.ConfigSyntax.CONF);
    }

    static ConfigNodePath parsePathNode(String path, com.gu.typesafe.config.ConfigSyntax flavor) {
    ...
    static Path parsePath(String path) {
        ...
        try {
            Iterator<Token> tokens = Tokenizer.tokenize(apiOrigin, reader,
                    com.gu.typesafe.config.ConfigSyntax.CONF);
            tokens.next(); // drop START
    ...
    protected static Path parsePathExpression(Iterator<Token> expression,
        ...
        return parsePathExpression(expression, origin, null, null, com.gu.typesafe.config.ConfigSyntax.CONF);
    }

    protected static Path parsePathExpression(Iterator<Token> expression,
                                              com.gu.typesafe.config.ConfigOrigin origin, String originalText) {
        return parsePathExpression(expression, origin, originalText, null, com.gu.typesafe.config.ConfigSyntax.CONF);
    }

    protected static ConfigNodePath parsePathNodeExpression(Iterator<Token> expression,
                                                            com.gu.typesafe.config.ConfigOrigin origin) {
        return parsePathNodeExpression(expression, origin, null, com.gu.typesafe.config.ConfigSyntax.CONF);
    }

    protected static ConfigNodePath parsePathNodeExpression(Iterator<Token> expression,
                                                            com.gu.typesafe.config.ConfigOrigin origin, String originalText, com.gu.typesafe.config.ConfigSyntax flavor) {
    ...
    private static Collection<Token> splitTokenOnPeriod(Token t, com.gu.typesafe.config.ConfigSyntax flavor) {
