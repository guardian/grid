...
public final class ConfigValueFactory {
     ...
     * {@link com.gu.typesafe.config.ConfigList}. If the <code>Iterable</code> is not an ordered
     ...
     * and returns {@link com.gu.typesafe.config.ConfigList} rather than {@link ConfigValue}.
     *
     * @param values list of plain Java values
     * @param originDescription description to use in {@link ConfigOrigin} of created values
     * @return a new {@link com.gu.typesafe.config.ConfigList} value
     */
    public static com.gu.typesafe.config.ConfigList fromIterable(Iterable<? extends Object> values,
                                                                 String originDescription) {
        return (com.gu.typesafe.config.ConfigList) fromAnyRef(values, originDescription);
    }
     ...
     *
     * @param values list of plain Java values
     * @return a new {@link com.gu.typesafe.config.ConfigList}
     */
