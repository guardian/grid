 ...
 * com.gu.typesafe.config.ConfigOrigin}. {@code ConfigOrigin}s are automatically created when you
 ...
 * {@link ConfigValue#withOrigin(com.gu.typesafe.config.ConfigOrigin)}.
 *
 * @since 1.3.0
 */
public final class ConfigOriginFactory {
     ...
     */
    public static com.gu.typesafe.config.ConfigOrigin newSimple() {
     ...
     * @return a new origin
     */
    public static com.gu.typesafe.config.ConfigOrigin newSimple(String description) {
     ...
     * @return a new origin
     */
    public static com.gu.typesafe.config.ConfigOrigin newFile(String filename) {
