...
object SyndicationUsageRequest {
  ...
  implicit val reads: Reads[SyndicationUsageRequest] =
    Json.reads[SyndicationUsageRequest]
  implicit val writes: Writes[SyndicationUsageRequest] =
    Json.writes[SyndicationUsageRequest]
}
