...
object UsageIdBuilder {
  ...
  def build(printUsageRecord: PrintUsageRecord) = buildId(
    List(
  ...
  def build(mediaWrapper: MediaWrapper) = buildId(
    List(
  ...
  def build(syndicationUsageRequest: SyndicationUsageRequest) = buildId(
    List(
  ...
  def build(frontUsageRequest: FrontUsageRequest) = buildId(
    List(
  ...
  def build(downloadUsageRequest: DownloadUsageRequest) = buildId(
    List(
