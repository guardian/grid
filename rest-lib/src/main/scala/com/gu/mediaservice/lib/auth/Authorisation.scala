...
import com.gu.mediaservice.lib.auth.Permissions.{ArchiveImages, DeleteImage, EditMetadata, PrincipalFilter, UploadImages, ViewDeletedImages}
...
//    implicit val ec = executionContext
  ...
  object CommonActionFilters {
    ...
    lazy val authorisedForViewDeletedImages = actionFilterFor(ViewDeletedImages)
  }
