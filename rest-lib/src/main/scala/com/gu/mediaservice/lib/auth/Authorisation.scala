...
import com.gu.mediaservice.lib.auth.Permissions.{ArchiveImages, DeleteImage, EditMetadata, PrincipalFilter, SoftDeleteImages, UploadImages}
...
//    implicit val ec = executionContext
  ...
  object CommonActionFilters {
    ...
    lazy val authorisedForSoftDeleteImages = actionFilterFor(SoftDeleteImages)
  }
