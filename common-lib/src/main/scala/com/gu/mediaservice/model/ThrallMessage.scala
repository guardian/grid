...
object ThrallMessage{
  ...
  implicit val imageLoremMessageFormat = Json.format[ImageMessage]
  implicit val updateIpsumPhotoshootMetadataMessage = Json.format[UpdateImagePhotoshootMetadataMessage]
