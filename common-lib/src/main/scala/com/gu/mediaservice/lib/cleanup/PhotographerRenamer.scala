...
object PhotographerRenamer extends MetadataCleaner {
  ...
  val names = Map(
    ...
    "Amadeusz Swierk" -> "Amadeusz Świerk",
    ...
    "Cristobal Basaure" -> "Cristóbal Basaure",
    ...
    "Dante Fernandez" -> "Dante Fernández",
    ...
    "Djordje Kojadinovic" -> "Đorđe Kojadinović",
    ...
    "Fermin Rodriguez" -> "Fermín Rodríguez",
    ...
    "Marcelo Perez del Carpio" -> "Marcelo Pérez del Carpio",
    "Marcelo Perez Del Carpio" -> "Marcelo Pérez del Carpio",
    ...
    "Muhammed Enes Yildirim" -> "Muhammed Enes Yıldırım",
    ...
    "Tomas Benedikovic" -> "Tomáš Benedikovič",
