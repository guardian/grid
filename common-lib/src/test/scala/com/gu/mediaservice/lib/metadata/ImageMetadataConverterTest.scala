...
class ImageMetadataConverterTest extends AnyFunSpec with Matchers {
  ...
  it("should return an empty ImageMetadata for empty FileMetadata") {
    ...
    imageMetadata.dateTaken should be (Symbol("empty"))
    imageMetadata.description should be (Symbol("empty"))
    imageMetadata.credit should be (Symbol("empty"))
    imageMetadata.byline should be (Symbol("empty"))
    imageMetadata.bylineTitle should be (Symbol("empty"))
    imageMetadata.title should be (Symbol("empty"))
    imageMetadata.copyright should be (Symbol("empty"))
    imageMetadata.suppliersReference should be (Symbol("empty"))
    imageMetadata.source should be (Symbol("empty"))
    imageMetadata.specialInstructions should be (Symbol("empty"))
    imageMetadata.keywords should be (Some(Set.empty))
    imageMetadata.subLocation should be (Symbol("empty"))
    imageMetadata.city should be (Symbol("empty"))
    imageMetadata.state should be (Symbol("empty"))
    imageMetadata.country should be (Symbol("empty"))
