...
new ImageCachePurger(app, "ImageCachePurgerLambda-euwest-1-PROD", { stack: "media-service", stage: "PROD", env: { region: "eu-west-1" } });
new ImageCachePurger(app, "ImageCachePurgerLambda-euwest-1-TEST", { stack: "media-service", stage: "TEST", env: { region: "eu-west-1" } });
