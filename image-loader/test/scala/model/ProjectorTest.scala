...
import com.gu.mediaservice.lib.cleanup.MetadataCleaner
...
class ProjectorTest extends FunSuite with Matchers with ScalaFutures with MockitoSugar {
  ...
  // TODO MRB: put these behind an interface at the top level so we can mock them here
  private val projector = new Projector(config, s3, imageOperations, null, null,  null)
  ...
  ignore("projectImage") {
    ...
    val expected = Image(
      ...
      metadata = ImageMetadata(
        ...
        None, Some("Christof Stache"), Some("Stringer"), None, Some("CHRISTOF STACHE"), Some("CHRISTOF STACHE"),
      ...
      originalMetadata = ImageMetadata(
        ...
        None, Some("CHRISTOF STACHE"), Some("CHRISTOF STACHE"), Some("-"),
