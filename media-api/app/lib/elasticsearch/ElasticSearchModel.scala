...
case class SearchParams(
                         ...
                         isSoftDeleted: Option[Boolean] = None,
...
object SearchParams {
  ...
  def apply(request: Authentication.Request[Any]): SearchParams = {
    ...
    SearchParams(
      ...
      request.getQueryString("isSoftDeleted") flatMap parseBooleanFromQuery,
  ...
  def toStringMap(searchParams: SearchParams): Map[String, String] =
    Map(
      ...
      "isSoftDeleted"     -> searchParams.isSoftDeleted.map(_.toString),
